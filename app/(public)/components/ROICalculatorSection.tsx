      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            >
              <div className="text-center">
                <h3 className="text-responsive-h3 text-card-foreground mb-2">
                  מספר הזמנות חודשיות
                </h3>
          ...
          <div className="grid md:grid-cols-3 gap-4 sm:gap-6">
            ...
            >
              <h4 className="text-destructive text-responsive-base font-extrabold mb-2">
                פלטפורמות משלוחים
              </h4>
            ...
            >
              <h4 className="text-card-foreground text-responsive-base font-extrabold mb-2">
                בוט וואטסאפ
              </h4>
            ...
            >
              <h4 className="text-primary text-responsive-base font-extrabold mb-2">
                החיסכון שלכם
              </h4>
              <div className="text-primary text-2xl sm:text-3xl font-extrabold mb-1">
          ...
          >
            <p className="text-accent-foreground text-responsive-base">
              💡 <strong>חיסכון שנתי משוער:</strong> ₪
