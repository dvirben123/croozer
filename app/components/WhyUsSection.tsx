      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-responsive-h2 mb-4 sm:mb-6 text-foreground text-center">
            ...
            <span className="text-primary block !text-[24px] sm:!text-[32px]">כי הוא יותר מכל פתרון אחר</span>
          </h2>
          ...
          {comparisons.map((comparison, index) => (
            ...
            >
              <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                ...
                <h3 className="text-responsive-h3 text-card-foreground text-right">{comparison.title}</h3>
              </div>
              ...
              {comparison.traditional && (
                ...
                >
                  <h4 className="text-destructive mb-2 text-right text-responsive-base font-extrabold">הדרך המסורתית:</h4>
                  <p className="text-responsive-base text-muted-foreground text-right">{comparison.traditional}</p>
                </motion.div>
              )}
              ...
              >
                <h4 className="text-primary mb-2 text-right text-responsive-base font-extrabold">עם הבוט שלנו:</h4>
                <p className="text-responsive-base text-muted-foreground text-right">{comparison.withBot}</p>
              </motion.div>
              ...
              >
                <span className="text-primary font-extrabold text-center text-responsive-base">{comparison.improvement}</span>
              </motion.div>
            </motion.div>
          ))}
        </div>
