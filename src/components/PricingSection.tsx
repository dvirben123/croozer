      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-responsive-h2 mb-4 sm:mb-6 text-foreground text-center">
            ...
            <span className="text-primary block !text-[24px] sm:!text-[32px]">תמחור שקוף - תוצאות מובטחות</span>
          </h2>
          ...
          {plans.map((plan, index) => (
            ...
            >
              ...
              >
                ...
                >
                  <plan.icon className={`h-5 w-5 sm:h-6 sm:w-6 ${plan.popular ? 'text-primary' : 'text-muted-foreground'}`} />
                </motion.div>
                
                <h3 className="text-responsive-h3 mb-1 text-card-foreground text-center">{plan.name}</h3>
                <p className="text-responsive-base text-muted-foreground mb-3 sm:mb-4 text-center">{plan.subtitle}</p>
                ...
                >
                  <div className="text-primary font-extrabold text-2xl sm:text-3xl">{plan.price}</div>
                  <span className="text-responsive-base text-muted-foreground">{plan.period}</span>
                </motion.div>
                
                <p className="text-responsive-base text-muted-foreground mb-4 sm:mb-6">{plan.description}</p>
                
                <div className="bg-accent/30 p-2 sm:p-3 rounded-lg mb-4 sm:mb-6">
                  <p className="text-responsive-base text-accent-foreground">{plan.highlight}</p>
                </div>
              </motion.div>
              ...
              >
                {plan.features.map((feature, featureIndex) => (
                  ...
                  >
                    <span className="text-responsive-base text-card-foreground flex-1">{feature}</span>
                    <motion.div
        ...
        >
          <h3 className="text-responsive-h3 mb-6 sm:mb-8 text-foreground text-center">שאלות נפוצות</h3>
              ...
              {[
                {
                  ...
                  answer: "ההקמה הבסיסית לוקחת כ-5 דקות בלבד! אתם מתחברים לחשבון הווטסאפ שלכם, בוחרים תבנית מתאימה לעסק ומתחילים לעבד הודעות מיד. עבור התאמות מתקדמות יותר, התהליך יכול לקחת עד יום עבודה אחד."
                },
                {
                  value: "item-2",
                  question: "האם הבוט יכול להחליף את שירות הלקוחות שלי לחלוטין?",
                  answer: "הבוט מטפל ב-80-90% מהפניות הבסיסיות באופן אוטומטי, וכך משחרר אתכם להתמקד בפניות המורכבות יותר. כשהבוט לא יודע לענות, הוא מעביר את השיחה אליכם באופן חלק ואלגנטי."
                },
                {
                  value: "item-3",
                  question: "מה קורה אם הלקוח רוצה לדבר עם בן אדם?",
                  answer: "הבוט יודע לזהות מתי הלקוח מעוניין לדבר עם בן אדם ומעביר את השיחה אליכם מיידית. אתם מקבלים התראה ויכולים להמשיך את השיחה בצורה חלקה מהנקודה שבה הבוט עצר."
                },
                {
                  value: "item-4",
                  question: "האם הבוט יכול לקבל הזמנות ותשלומים?",
                  answer: "בהחלט! הבוט יכול להציג תפריט, לקבל הזמנות, לחשב מחירים, ואפילו לקבל תשלומים באמצעות חיבור למערכות התשלום הפופולריות כמו Paybox, Cardcom ואחרות."
                },
                {
                  value: "item-5",
                  question: "איך הבוט יודע מה לענות?",
                  answer: "הבוט משתמש בבינה מלאכותית מתקדמת שלומדת מהשיחות והמידע שאתם מזינים לו. אתם יכולים להגדיר תשובות מוכנות לשאלות נפוצות, ולהוסיף מידע על המוצרים והשירותים שלכם."
                },
                {
                  value: "item-6",
                  question: "מה עם אבטחה ופרטיות של הלקוחות?",
                  answer: "אנחנו נוקטים בסטנדרטים הכי גבוהים של אבטחת מידע. כל הנתונים מוצפנים, אנחנו לא שומרים פרטי תשלום, ופועלים בהתאם לחוק הגנת הפרטיות בישראל ותקנות GDPR."
                }
              ].map((faq, index) => (
                <motion.div
                  key={index}
